...
(function () {
  ...
  const clientRadarChartEl = document.querySelector('#clientRadarChart'),
    clientRadarOptions = {
      ...
      xaxis: {
          categories: ['ENTREPRENEUR', 'IDÉE', 'PROTOTYPE', 'CLIENT', 'BUSINESS PLAN', 'ECOSYSTEM']
      },
      yaxis: {
          tickAmount: 6,
          min: 0,
  ...
  const cardiacFrequencyChartEl = document.querySelector('#cardiacFrequencyChart'),
        cardiacFrequencyChartOptions = {
            series: [
                {
                    name: 'Cardiac Frequency',
                    data: [72, 75, 78, 77, 76, 80, 82, 79, 78, 76, 74, 73]
                }
            ],
            chart: {
                height: 500,
            ...
            title: {
                text: 'Cardiac Frequency Over Time',
                align: 'left'
            },
            grid: {
                row: {
        ...
        if (typeof cardiacFrequencyChartEl !== undefined && cardiacFrequencyChartEl !== null) {
